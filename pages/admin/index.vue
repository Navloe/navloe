  ...
  <div class="flex items-center justify-center h-screen">
    <div class="p-8">
      ...
      <form @submit.prevent="handleLogin()">
        ...
        <button type="submit" class="flex items-center justify-center px-4 py-3 mt-6 text-white border-0 text-sm w-full" :class="isLoading ? 'bg-blue-300' : 'bg-primary'">
...
<script lang="ts" setup>
  ...
  const email = ref("admin@navloe.com");
  const password = ref("navloe1!1oelvan");
